...
return normalize(cross(dFdx(positionView), dFdy(positionView)));
  ...
  `)}},22860:(e,t,o)=>{o.d(t,{L:()=>n});var a=o(96236),r=o(46855),i=o(16878);function n(e,t){switch(t.output){case a.V.Shadow:case a.V.ShadowHighlight:case a.V.ShadowExcludeHighlight:case a.V.ViewshedShadow:e.fragment.include(r.U),e.fragment.code.add(i.H`float _calculateFragDepth(const in float depth) {
...
float evaluateAmbientOcclusion() { return 0.0; }`)}},40117:(e,t,o)=>{o.d(t,{E:()=>b});var a=o(49443),r=o(96236),i=o(75304),n=o(50366),s=o(16213),l=o(78731),c=o(69261),d=o(8375),u=o(22860),m=o(65228),h=o(75762),v=o(79867),p=o(35490),f=o(16878),g=o(67058),x=o(71723);function b(e,t){const{vertex:o,fragment:b}=e,T=t.hasColorTexture&&t.alphaDiscardMode!==x.sf.Opaque,{output:M,normalType:w,hasColorTextureTransform:y}=t;switch(M){case r.V.Depth:(0,p.NB)(o,t),e.include(n.d,t),e.fragment.include(i.HQ,t),e.include(c.U,t),T&&b.uniforms.add(new g.N("tex",(e=>e.texture))),o.main.add(f.H`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
...
forwardTextureCoordinates();`),e.fragment.include(i.HQ,t),e.include(v.S,t),e.include(m.Q,t),b.main.add(f.H`
    ...
    `)),(0,i.RN)(D)){const{hasColorTexture:a,hasColorTextureTransform:r,receiveShadows:i}=e;t.include(g.kA,e),t.include(f.n,e),t.include(C.S,e),t.include(e.instancedDoublePrecision?M.G:M.Bz,e),t.fragment.include(n.HQ,e),t.include(H.z,e),(0,O.yu)(t.fragment,e),(0,x.Gc)(R),(0,g.a8)(R),(0,g.eU)(R),R.uniforms.add(o.uniforms.get("localOrigin"),o.uniforms.get("view"),new _.t("ambient",(e=>e.ambient)),new _.t("diffuse",(e=>e.diffuse)),new E.m("opacity",(e=>e.opacity)),new E.m("layerOpacity",(e=>e.layerOpacity))),a&&R.uniforms.add(new I.N("tex",(e=>e.texture))),t.include(T._Z,e),t.include(b.c,e),R.include(S.N),(0,x.O4)(R),R.main.add(A.H`
      ...
      vec4 finalColor = vec4(shadedColor, opacity_);
      outputColorHighlightOID(finalColor, vpos);`)}return t.include(p.E,e),t}const P=Object.freeze(Object.defineProperty({__proto__:null,build:R},Symbol.toStringTag,{value:"Module"}))},46855:(e,t,o)=>{o.d(t,{U:()=>r});var a=o(16878);function r(e){e.code.add(a.H`const float MAX_RGBA4_FLOAT =
15.0 / 16.0 +
15.0 / 16.0 / 16.0 +
15.0 / 16.0 / 16.0 / 16.0 +
...
rawNormal.xy = (normalTextureRotation * vec3(rawNormal.x, rawNormal.y, 1.0)).xy;`),o.code.add(c.H`return tangentSpace * rawNormal;
    ...
    }`)}const T=(0,s.vt)()},71425:(e,t,o)=>{o.d(t,{N:()=>n});var a=o(44873),r=o(66652),i=o(16878);function n(e){e.include(r.a),e.code.add(i.H`
...
return posClip;
}`)}},79867:(e,t,o)=>{o.d(t,{S:()=>l});o(73031);var a=o(826);a.n;var r=o(42403),i=o(16878),n=o(71723),s=o(12621);function l(e,t){c(e,t,new r.m("textureAlphaCutoff",(e=>e.textureAlphaCutoff)))}function c(e,t,o){const a=e.fragment,r=t.alphaDiscardMode,l=r===n.sf.Blend;r!==n.sf.Mask&&r!==n.sf.MaskBlend||a.uniforms.add(o),a.code.add(i.H`
    void discardOrAdjustAlpha(inout vec4 color) {
      ${r===n.sf.Opaque?"color.a = 1.0;":`if (color.a < ${l?i.H.float(s.Q):"textureAlphaCutoff"}) {\n              discard;\n             } ${(0,i.If)(r===n.sf.Mask,"else { color.a = 1.0; }")}`}
    }
  `)}},82833:(e,t,o)=>{o.d(t,{Bz:()=>v,G:()=>h});o(10382),o(28473);var a=o(46855),r=o(34927),i=o(16878),n=o(68017),s=o(73031),l=o(826);class c extends l.n{constructor(e,t,o){super(e,"mat4",s.c.Draw,((o,a,r,i)=>o.setUniformMatrix4fv(e,t(a,r,i))),o)}}class d extends l.n{constructor(e,t,o){super(e,"mat4",s.c.Pass,((o,a,r)=>o.setUniformMatrix4fv(e,t(a,r))),o)}}var u=o(73712),m=o(20783);m.Y;m.Y;function h(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new d("shadowMapMatrix",((e,t)=>t.shadowMap.getShadowMapMatrices(e.origin)),4)),p(e))}function v(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new c("shadowMapMatrix",((e,t)=>t.shadowMap.getShadowMapMatrices(e.origin)),4)),p(e))}function p(e){const t=e.fragment;t.include(a.U),t.uniforms.add(new u.x("shadowMap",(e=>e.shadowMap.depthTexture)),new n.W("numCascades",(e=>e.shadowMap.numCascades)),new r.I("cascadeDistances",(e=>e.shadowMap.cascadeDistances))).code.add(i.H`int chooseCascade(float depth, out mat4 mat) {
...
}`);break;default:(0,i.Xb)(t.doubleSidedMode);case a.COUNT:}}(r=a||(a={}))[r.None=0]="None",r[r.View=1]="View",r[r.WindingOrder=2]="WindingOrder",r[r.COUNT=3]="COUNT"}}]);