"use strict";(self.webpackChunkever_wading_birds=self.webpackChunkever_wading_birds||[]).push([[71446,75204],{826:(e,o,t)=>{t.d(o,{n:()=>n});t(21265);var r=t(73031);class n{constructor(e,o,t,n){let a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null;if(this.name=e,this.type=o,this.arraySize=a,this.bind={[r.c.Bind]:null,[r.c.Pass]:null,[r.c.Draw]:null},n)switch(t){case void 0:break;case r.c.Bind:this.bind[r.c.Bind]=n;break;case r.c.Pass:this.bind[r.c.Pass]=n;break;case r.c.Draw:this.bind[r.c.Draw]=n}}equals(e){return this.type===e.type&&this.name===e.name&&this.arraySize===e.arraySize}}},6513:(e,o,t)=>{t.d(o,{E7:()=>T,gP:()=>r,s0:()=>n,zP:()=>C});var r,n,a,l=t(88242),i=t(16213),d=t(31500),c=t(42162),s=t(8815),u=t(57554),f=t(16878),m=t(91018),v=t(80203),p=t(38950),x=t(81775),h=t(22131);function T(e,o){const t=e.vertex;t.include(c.W),e.include(i.Y,o);const{silhouette:r,legacy:n,spherical:a}=o;t.uniforms.add(new x.o("componentDataTex",(e=>e.componentDataTexture))),e.attributes.add(h.r.COMPONENTINDEX,"float");t.constants.add("lineWidthFractionFactor","float",8),t.constants.add("extensionLengthOffset","float",128),t.code.add(f.H`
...
}`)),r?(e.attributes.add(h.r.NORMAL2COMPRESSED,"vec2"),t.code.add(f.H`vec3 worldNormal(ComponentData data) {
...
return vec2(coordX, coordY) + 0.5;
  ...
  float readElevationOffset() {
    ...
    return uninterpolatedRGBAToFloat(encodedElevation) * ${c.H.float(T)};
  }
