...
}`)}},34289:(e,t,r)=>{r.d(t,{SL:()=>s,wR:()=>a});var i=r(22131),o=r(92156),n=r(605);const a=[],s=[new n._(i.r.POSITION,3,o.pe.FLOAT,0,12)];new n._(i.r.POSITION,2,o.pe.FLOAT,0,8),new n._(i.r.POSITION,2,o.pe.FLOAT,0,16),new n._(i.r.UV0,2,o.pe.FLOAT,8,16)},37958:(e,t,r)=>{r.d(t,{H:()=>l,a:()=>g,b:()=>u,c:()=>c,g:()=>h,o:()=>d});var i=r(37379),o=r(16878),n=r(81775),a=r(20783),s=r(8118);class l extends a.Y{}function c(){const e=new s.N5,{outputs:t,fragment:r}=e;return e.include(i.c),r.uniforms.add(new n.o("textureInput",(e=>e.input))),r.constants.add("outlineWidth","int",Math.ceil(d)),r.constants.add("cellSize","int",h),t.add("fragGrid","vec2"),r.main.add(o.H`ivec2 inputTextureSize = textureSize(textureInput, 0);
...
fragGrid = vec2(outputValue) / 255.0;`),e}const h=32,d=9,u=.4,g=Object.freeze(Object.defineProperty({__proto__:null,HighlightDownsampleDrawParameters:l,blurSize:u,build:c,gridCellPixelSize:h,outlineSize:d},Symbol.toStringTag,{value:"Module"}))},38319:(e,t,r)=>{r.d(t,{W:()=>n});var i=r(60984),o=r(30051);class n extends i.im{intersect(e,t,r,i,n,a){return(0,o.Uy)(e,r,i,n,void 0,a)}}},39540:(e,t,r)=>{r.d(t,{v:()=>n,z:()=>o});var i=r(16878);function o(e){e.fragment.code.add(i.H`float normals2FoamIntensity(vec3 n, float waveStrength){
...
}`)}},44106:(e,t,r)=>{var i,o,n;r.d(t,{vr:()=>i}),function(e){e[e.INNER=0]="INNER",e[e.OUTER=1]="OUTER"}(i||(i={})),function(e){e[e.REGULAR=0]="REGULAR",e[e.HAS_NORTH_POLE=1]="HAS_NORTH_POLE",e[e.HAS_SOUTH_POLE=2]="HAS_SOUTH_POLE",e[e.HAS_BOTH_POLES=3]="HAS_BOTH_POLES"}(o||(o={})),function(e){e[e.FADING=0]="FADING",e[e.IMMEDIATE=1]="IMMEDIATE",e[e.UNFADED=2]="UNFADED"}(n||(n={}))},45644:(e,t,r)=>{r.d(t,{A:()=>c,C:()=>l});var i=r(67093),o=r(66028),n=r(12288),a=r(50190),s=r(2948);function l(e,t,r,i){const s="polygon"===e.type?n.Wq.CCW_IS_HOLE:n.Wq.NONE,l="polygon"===e.type?e.rings:e.paths,{position:c,outlines:d}=(0,n.oR)(l,!!e.hasZ,s,e.spatialReference),u=(0,o.jh)(c.length),g=(0,a.au)(c,e.spatialReference,0,u,0,c,0,c.length/3,t,r,i),p=null!=g;return{lines:p?h(d,c,u):[],projectionSuccess:p,sampledElevation:g}}function c(e,t){const r="polygon"===e.type?n.Wq.CCW_IS_HOLE:n.Wq.NONE,o="polygon"===e.type?e.rings:e.paths,{position:a,outlines:l}=(0,n.oR)(o,!1,r),c=(0,i.projectBuffer)(a,e.spatialReference,0,a,t,0);for(let i=2;i<a.length;i+=3)a[i]=s.bi;return{lines:c?h(l,a):[],projectionSuccess:c}}function h(e,t){let r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;const i=new Array;for(const{index:n,count:a}of e){if(a<=1)continue;const e=3*n,s=3*a;i.push({position:(0,o.l5)(t,3*n,3*a),mapPositions:null!=r?(0,o.l5)(r,e,s):void 0})}return i}},49631:(e,t,r)=>{r.d(t,{T:()=>h,a:()=>u,b:()=>d});var i=r(28473),o=r(37379),n=r(57554),a=r(16878),s=r(67058),l=r(20783),c=r(8118);class h extends l.Y{constructor(){super(...arguments),this.color=(0,i.fA)(1,1,1)}}function d(){const e=new c.N5;return e.include(o.c),e.fragment.uniforms.add(new s.N("tex",(e=>e.texture)),new n.t("uColor",(e=>e.color))),e.fragment.main.add(a.H`vec4 texColor = texture(tex, uv);
fragColor = texColor * vec4(uColor, 1.0);`),e}const u=Object.freeze(Object.defineProperty({__proto__:null,TextureOnlyPassParameters:h,build:d},Symbol.toStringTag,{value:"Module"}))},54366:(e,t,r)=>{r.d(t,{C:()=>m,b:()=>v});var i=r(75304),o=r(50366),n=r(78731),a=r(769),s=r(61535),l=r(75762),c=r(66652),h=r(35490),d=r(94409),u=r(16878),g=r(22131),p=r(14480),f=r(8118);function v(e){const t=new f.N5,{vertex:r,fragment:v,attributes:m,varyings:_}=t,{vvColor:y,hasVertexColors:x}=e;return(0,h.NB)(r,e),t.include(o.d,e),t.include(a.c,e),t.include(l.A,e),t.include(n.g,e),v.include(i.HQ,e),t.include(p.z,e),t.include(s.Z,e),m.add(g.r.POSITION,"vec3"),y&&m.add(g.r.COLORFEATUREATTRIBUTE,"float"),x||_.add("vColor","vec4"),_.add("vpos","vec3"),r.uniforms.add(new d.E("uColor",(e=>e.color))),r.main.add(u.H`
      vpos = position;
